...
invasive_sums_graph <- make_graph_of_sums_invasive_collection(fish_name_list)

write.csv(invasive_sums_graph, here("csv", "sums_of_invasive_fish_consumption.csv"), row.names = FALSE)